...
public class GuaGuaKa extends View
{
	...
	//	private String mText = JuDuiHuanActivity.drawn;
	...
	{
		try {
			//		if (GuaYiGuaActivity.drawn == null) {
			////			mText = "恭喜您,抽中5等奖";
			//			mText = JuDuiHuanActivity.drawn_ll;
			//			JuDuiHuanActivity.drawn_ll = "";
			//		}
			//		else {
			//			mText =	GuaYiGuaActivity.drawn;
			//		}
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
	{
		...
		mCanvas.drawBitmap(BitmapFactory.decodeResource(getResources(),
				R.drawable.gyg_bise), null, new RectF(0, 0, width, height), null);
	}

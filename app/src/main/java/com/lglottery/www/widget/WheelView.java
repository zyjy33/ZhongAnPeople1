...
import com.lglottery.www.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private static final int[] SHADOWS_COLORS = new int[] { R.color.no_color,
			R.color.no_color, R.color.no_color };
	...
	private void initResourcesIfNecessary() {
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(
					R.drawable.lglottery_go_content);
		}
		...
		setBackgroundResource(R.color.no_color);
	}

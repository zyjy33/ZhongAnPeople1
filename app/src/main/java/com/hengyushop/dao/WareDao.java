...
public class WareDao {
	...
	public boolean insertFoodClassify(DotClassifyData data) {
		...
		boolean isInsert = false;
		ContentValues cv = new ContentValues();
		cv.put("_ProductCategoryID", data.getProductCategoryID());
		cv.put("ProductTypeName", data.getProductTypeName());
	...
	public boolean insertFoodContent(DotContentData data) {
		...
		boolean isInsert = false;
		ContentValues cv = new ContentValues();
		cv.put("_ProID", data.getProID());
		cv.put("ProductCategoryID", data.getProductCategoryID());
		cv.put("ProName", data.getProName());
		cv.put("proFaceImg", data.getProFaceImg());
		cv.put("proFaceBigImg", data.getProFaceBigImg());
		cv.put("originalityPrice", data.getOriginalityPrice());
		cv.put("retailPrice", data.getRetailPrice());
		cv.put("proComputerInfo", data.getProComputerInfo());
	...
	public List<DotClassifyData> findAllClassify() {
		...
		String sql = "select * from foodclassify";

		Cursor cur = db.rawQuery(sql, null);
		while (cur.moveToNext()) {
			DotClassifyData data = new DotClassifyData();
			int ProductCategoryID = cur.getInt(cur
					.getColumnIndex("_ProductCategoryID"));
			String ProductTypeName = cur.getString(cur
					.getColumnIndex("ProductTypeName"));
			data.setProductCategoryID(ProductCategoryID);

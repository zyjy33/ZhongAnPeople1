...
import com.zams.www.AddUserAddressActivity;
import com.zams.www.AddressManagerActivity;
...
public class JuTuanConfrimActivity extends BaseActivity {
			...
			public void onSuccess(int arg0, String arg1) {
				...
				try {
					...
					if (status.equals("y")) {
						...
						progress.CloseProgress();
						Toast.makeText(JuTuanConfrimActivity.this, info, 200)
								.show();
					}
					if (len != 0) {
	...
	private void loadtuangou(String payment_id, int kou_hongbao) {
		...
		String buy_no = getIntent().getStringExtra("buy_no");
		System.out.println("buy_no=====================" + buy_no);
		url = RealmName.REALM_NAME_LL + "/" + apl_jiekou + "?user_id="

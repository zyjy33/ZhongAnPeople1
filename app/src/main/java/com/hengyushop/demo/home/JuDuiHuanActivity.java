...
//			ll_buju_tp.setBackgroundResource(R.drawable.zams_jfg);
    ...
    private void userqiandao() {
        try {
            ...
            String strUrlone = RealmName.REALM_NAME_LL + "/comment_sign_in?user_id=" + user_id + "&user_name="
            ...
            AsyncHttp.get(strUrlone, new AsyncHttpResponseHandler() {
                public void onSuccess(int arg0, String arg1) {
                    try {
                        ...
                        if (status.equals("y")) {
                            ...
                            Toast.makeText(JuDuiHuanActivity.this, info, Toast.LENGTH_SHORT)
                                    .show();
                ...
                public void onFailure(Throwable arg0, String arg1) {
                    ...
                    super.onFailure(arg0, arg1);
                    Toast.makeText(JuDuiHuanActivity.this, "访问接口失败", Toast.LENGTH_SHORT)
                            .show();
                }
            }, JuDuiHuanActivity.this);
    ...
    private void jianceqiandao() {
        try {
            ...
            String user_name = spPreferences.getString("user", "");
            String login_sign = spPreferences.getString("login_sign", "");
            String strUrlone = RealmName.REALM_NAME_LL + "/comment_sign_exist?user_id=" + user_id + "&user_name="
                    + user_name + "&login_sign=" + login_sign + "";
    ...
    // String info = object.getString("info");
    // if (status.equals("y")) {
    // // Toast.makeText(ZhuanYiZhuanActivity.this, info, Toast.LENGTH_SHORT).show();
    ...
    // }else{
    // Toast.makeText(JuDuiHuanActivity.this, info, Toast.LENGTH_SHORT).show();
    // }
    ...
    // // Toast.makeText(ZhuanYiZhuanActivity.this, "访问接口失败", Toast.LENGTH_SHORT).show();
    // }
    // }, JuDuiHuanActivity.this);
    //
    // }

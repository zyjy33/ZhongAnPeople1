...
//				String data = "http://183.62.138.31:1010/mobile/goods/show-" + sp_id + ".html?user_id="+user_id+"&user_name="+user_name+"";
				String data_sp = subtitle + RealmName.REALM_NAME_FX+"/goods/show-" + sp_id + ".html?cid="+company_id+"&unionid="+unionid+"&shareid="+user_id+"&from=android";
...
//				String data_sp = subtitle + RealmName.REALM_NAME_FX+"/goods/show-" + sp_id + ".html?cid="+company_id+"&unionid="+unionid+"&shareid="+user_id+"&from=android";
				String data_pt = subtitle + RealmName.REALM_NAME_FX+"/"+fx_shuzi+"/show-"+pt_id+".html?cid="+company_id+"&unionid="+unionid+"&shareid="+user_id+"&from=android";
				...
				String data_ct = subtitle + RealmName.REALM_NAME_FX+"/"+fx_shuzi+"/join-"+ct_id+".html?cid="+company_id+"&unionid="+unionid+"&shareid="+user_id+"&from=android";
				...
				String data_hdfx = subtitle + RealmName.REALM_NAME_FX + "/signup/show/"+activity_id+".html?unionid="+unionid+"&shareid="+user_id+"&from=android";
//				                                  http://mobile.zams.cn/signup/show/8941.html?unionid=o-Qe5v63lGJMH3R_zxgK_eSMRz3s&shareid=5721&from=singlemessage
				...
				String data_xw = subtitle + RealmName.REALM_NAME_FX + "/mobile/news/conent-"+list_id+".html?unionid="+unionid+"&shareid="+user_id+"&from=android";
	...
	private void softshareWxChat(String text) {
		...
		api = WXAPIFactory.createWXAPI(DBFengXiangActivity.this, Constant.APP_ID,false);
...
//			msg1.description = temp[0];//Bitmap
			...
			msg.thumbData = Util.bmpToByteArray(thumb1, true);// 设置缩略图

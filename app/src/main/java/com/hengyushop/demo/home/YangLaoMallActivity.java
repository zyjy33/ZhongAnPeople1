 ...
 * 
 */
public class YangLaoMallActivity extends BaseActivity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		progress = new DialogProgress(YangLaoMallActivity.this);
		intren();
		loadWeather();
	}
	public void intren() {
...
//		tv_titel.setText(title);
	...
	private Handler handler = new Handler(){
				...
				try {
					...
					gridview.setOnItemClickListener(new OnItemClickListener() {
						...
						public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
							...
							Intent intent = new Intent(YangLaoMallActivity.this, WareInformationActivity.class);
		...
		private void loadWeather() {
			...
			AsyncHttp.get(RealmName.REALM_NAME_LL + "/get_article_page_size_list?channel_name=mall&category_id="+0+"" +

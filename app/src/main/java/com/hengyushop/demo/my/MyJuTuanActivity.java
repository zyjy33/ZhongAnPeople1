...
import com.android.hengyu.pub.MyJuTuanOrderAdapter;
 ...
 *
 */
public class MyJuTuanActivity extends BaseActivity implements OnClickListener {
	private ImageView iv_fanhui, cursor1, cursor2, cursor22, cursor3, cursor4,
			cursor5;
	private Button fanhui, btn_chongzhi;
	private LinearLayout index_item0, index_item1, index_item2, index_item22,
			index_item3, index_item4;
	private SharedPreferences spPreferences;
	private PullToRefreshView refresh;
	private ListView my_list;
	private MyJuTuanOrderAdapter madapter;
	...
	int len;
	// String strwhere = "datatype=3";
	String strwhere = "datatype%20in(4,5,7)";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_my_jutuan_order_list);
		spPreferences = getSharedPreferences("longuserset", MODE_PRIVATE);
		user_name = spPreferences.getString("user", "");
		user_id = spPreferences.getString("user_id", "");
		progress = new DialogProgress(MyJuTuanActivity.this);
		Initialize();
		list = new ArrayList<MyOrderData>();
		madapter = new MyJuTuanOrderAdapter(list, MyJuTuanActivity.this,
				handler);
	...
	protected void onDestroy() {
		...
		if (MyJuTuanOrderAdapter.type == true) {
			...
			MyJuTuanOrderAdapter.type = false;
		}
	...
	private void Initialize() {
		...
		try {
			...
			index_item22 = (LinearLayout) findViewById(R.id.index_item22);
			...
			cursor22 = (ImageView) findViewById(R.id.cursor22);
			...
			index_item22.setOnClickListener(this);
	...
	public void onClick(View v) {
		...
		switch (v.getId()) {
			...
			case R.id.index_item1:
				item2();
				// 待付款
				strwhere = "payment_status=1%20and%20datatype%20in(4,5,7)";
				System.out.println("=========22============" + strwhere);
				load_list(true, strwhere);
				break;
			case R.id.index_item22:
				item22();
				// 待成团
				strwhere = "payment_status=2%20and%20activity_people!=activity_member%20and%20status=2%20and%20datatype%20in(4,5,7)";
			...
			case R.id.index_item2:
				item3();
				// 已成团
				strwhere = "payment_status=2%20and%20activity_people=activity_member%20and%20express_status=1%20and%20status=2%20and%20datatype%20in(4,5,7)";
				System.out.println("=========33============" + strwhere);
				load_list(true, strwhere);
				break;
			case R.id.index_item3:
				item4();
				// 待收货
				strwhere = "payment_status=2%20and%20express_status=2%20and%20status=2%20and%20datatype%20in(4,5,7)";
			...
			case R.id.index_item4:
				item5();
				// 已完成
				strwhere = "payment_status=2%20and%20express_status=2%20and%20status=3%20and%20datatype%20in(4,5,7)";
	...
	private void item1() {
		...
		cursor22.setVisibility(View.INVISIBLE);
	...
	private void item22() {
		cursor1.setVisibility(View.INVISIBLE);
		cursor2.setVisibility(View.INVISIBLE);
		cursor22.setVisibility(View.VISIBLE);
		cursor3.setVisibility(View.INVISIBLE);
		cursor4.setVisibility(View.INVISIBLE);
		cursor5.setVisibility(View.INVISIBLE);
	}
	...
	private void load_list(boolean flag, String strwhere) {
		try {
			...
			// "/get_order_groupon_size_list?user_id="+user_id+"" +
			// "&page_size="+VIEW_NUM+"&page_index="+CURRENT_NUM+"&strwhere="+strwhere+"&orderby=",
			AsyncHttp.get(RealmName.REALM_NAME_LL
							+ "/get_order_activity_page_size_list?user_id=" + user_id
							+ "" + "&page_size=" + VIEW_NUM + "&page_index="
							+ CURRENT_NUM + "&strwhere=" + strwhere + "&orderby=",
					new AsyncHttpResponseHandler() {
								...
								if (status.equals("y")) {
									...
									for (int i = 0; i < jsonArray.length(); i++) {
										...
										for (int j = 0; j < ja.length(); j++) {
											...
											mb.setGoods_price(jo
													.getString("activity_price"));
											mb.setAward_status(jo
													.getString("award_status"));
											mb.setGroupon_item_people(jo
													.getString("activity_people"));
											mb.setGroupon_item_member(jo
													.getString("activity_member"));
											mb.setGroupon_img_url(jo
													.getString("img_url"));
											mb.setOrder_id(jo
													.getString("order_id"));
									...
									if (list.size() == 0) {
										...
										Toast.makeText(MyJuTuanActivity.this,
												"没有订单了", 200).show();
									}
								}
						...
						public void onFailure(Throwable arg0,String arg1) {
							...
							Toast.makeText(MyJuTuanActivity.this, "链接异常", 200).show();
						}
			...
			switch (msg.what) {
				...
				case 5:// 支付宝
					...
					if (TextUtils.equals(resultStatus, "9000")) {
						Toast.makeText(MyJuTuanActivity.this, "支付成功",
						...
						if (TextUtils.equals(resultStatus, "8000")) {
							Toast.makeText(MyJuTuanActivity.this, "支付结果确认中",
									Toast.LENGTH_SHORT).show();

						} else {
							// 其他值就可以判断为支付失败，包括用户主动取消支付，或者系统返回的错误
							Toast.makeText(MyJuTuanActivity.this, "支付失败",
									Toast.LENGTH_SHORT).show();
	...
	protected void dialog2() {
		AlertDialog.Builder builder = new Builder(MyJuTuanActivity.this);
		...
		AsyncHttp.get(RealmName.REALM_NAME_LL
			...
			public void onSuccess(int arg0, String arg1) {
				...
				try {
					...
					if (status.equals("y")) {
						progress.CloseProgress();
						Toast.makeText(MyJuTuanActivity.this, info, 200).show();
					} else {
						progress.CloseProgress();
						Toast.makeText(MyJuTuanActivity.this, info, 200).show();
					}
				...
				new AsyncHttpResponseHandler() {
					...
					public void onSuccess(int arg0, String arg1) {
						...
						try {
							...
							if (status.equals("y")) {
								progress.CloseProgress();
								Toast.makeText(MyJuTuanActivity.this, info, 200)
										.show();
								load_list(true, strwhere);
								madapter.notifyDataSetChanged();
							} else {
					...
					new AsyncHttpResponseHandler() {
						...
						public void onSuccess(int arg0, String arg1) {
							...
							try {
								...
								if (status.equals("y")) {
									...
									Toast.makeText(MyJuTuanActivity.this, info, 200)
											.show();
									Intent intent = new Intent(MyJuTuanActivity.this,
						...
						public void onFailure(Throwable arg0, String arg1) {
							...
							System.out.println("22================================="
									+ arg1);
							Toast.makeText(MyJuTuanActivity.this, "更新订单网络超时异常", 200)
									.show();
						}

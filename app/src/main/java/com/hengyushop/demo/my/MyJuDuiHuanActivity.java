...
public class MyJuDuiHuanActivity extends BaseActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        madapter = new MyJuDuiHuanOrderAdapter(list, MyJuDuiHuanActivity.this, handler);
    ...
    private void Initialize() {
        ...
        try {
            ...
            imageView1.setBackgroundDrawable(getResources().getDrawable(R.drawable.no_data));
                        ...
                        try {
                            ...
                            if (status.equals("y")) {
                                ...
                                if (list.size() == 0) {
                                    ...
                                    Toast.makeText(MyJuDuiHuanActivity.this, "没有订单了", Toast.LENGTH_SHORT).show();
                                }
                            }
        ...
        AsyncHttp.get(RealmName.REALM_NAME_LL
            ...
            public void onSuccess(int arg0, String arg1) {
                ...
                try {
                    ...
                    if (status.equals("y")) {
                        progress.CloseProgress();
                        Toast.makeText(MyJuDuiHuanActivity.this, info, Toast.LENGTH_SHORT)
                                .show();
                    } else {
                        progress.CloseProgress();
                        Toast.makeText(MyJuDuiHuanActivity.this, info, Toast.LENGTH_SHORT)
                    ...
                    new AsyncHttpResponseHandler() {
                        ...
                        public void onSuccess(int arg0, String arg1) {
                            ...
                            try {
                                ...
                                if (status.equals("y")) {
                                    ...
                                    Toast.makeText(MyJuDuiHuanActivity.this, info, Toast.LENGTH_SHORT)
                                            .show();
                                    Intent intent = new Intent(MyJuDuiHuanActivity.this, ZhiFuOKActivity.class);
                                    startActivity(intent);
                                } else {
                                    progress.CloseProgress();
                                    teby = false;
                        ...
                        public void onFailure(Throwable arg0, String arg1) {
                            ...
                            System.out.println("22================================="
                                    + arg1);
                            Toast.makeText(MyJuDuiHuanActivity.this, "更新订单网络超时异常", Toast.LENGTH_SHORT)
                                    .show();
                        }

...
public class ChongZhiActivity extends BaseActivity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//				// TODO Auto-generated method stub
		////				chongzhi_edit.setText(chongzhi_edit.getText());
				...
				try {
					...
					if (monney >= 100) {
						...
						if(yu_pay_c0.isChecked()){
							...
							//						Toast.makeText(getApplicationContext(), "暂时无法支付",200).show();
						...
						Toast.makeText(getApplicationContext(), "请输入正确的金额,不能小于100", 200).show();
					}
				} catch (NumberFormatException e) {
					e.printStackTrace();
					Toast.makeText(getApplicationContext(), "请输入金额", 200).show();
				}
						...
						public void onSuccess(int arg0, String arg1) {
							...
							try {
								...
								if (status.equals("y")) {
									...
									if (fangshi.equals("2")) {
										Intent intent = new Intent(ChongZhiActivity.this, TishiChongZhiActivity.class);

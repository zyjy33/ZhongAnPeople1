 ...
 *
 */
public class MyJuTuanOrderXqActivity extends BaseActivity implements
		OnClickListener {
	...
	private TextView tv_shanche, tv_chengyuan, tv_fukuan, tv_queren_fukuan,
			tv_pingjia;
	...
	MyOrderData md;
	OrderBean mb;
	private MyJuTuanOrderXqAdapter mybAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		progress = new DialogProgress(MyJuTuanOrderXqActivity.this);
		...
		try {
			...
			// tv_chengyuan.setOnClickListener(this);
			...
			mybAdapter = new MyJuTuanOrderXqAdapter(
					MyJuTuanOrderXqActivity.this, list, handler);
	...
	protected void dialog2() {
		AlertDialog.Builder builder = new Builder(MyJuTuanOrderXqActivity.this);
					...
					public void onSuccess(int arg0, String arg1) {
						...
						try {
							...
							if (status.equals("y")) {
								...
								Toast.makeText(MyJuTuanOrderXqActivity.this,
										info, 200).show();
	...
	public void onClick(View v) {
		...
		switch (v.getId()) {
			...
			case R.id.tv_fukuang:
				...
				Intent intent = new Intent(MyJuTuanOrderXqActivity.this,
			...
			case R.id.tv_queren_fukuan:
				Intent intent1 = new Intent(MyJuTuanOrderXqActivity.this,
			...
			case R.id.tv_pingjia:
				Intent intent2 = new Intent(MyJuTuanOrderXqActivity.this,
			...
			case R.id.tv_shanche:
				dialog3();
				break;
			// case R.id.tv_chengyuan:
			// Intent intent3 = new Intent(MyJuTuanOrderXqActivity.this,
			// Webview1.class);
			// intent3.putExtra("ct_id",list.get(0).getList().get(0).getOrder_id());
					...
					new AsyncHttpResponseHandler() {
						...
						public void onSuccess(int arg0, String arg1) {
							...
							try {
								...
								if (status.equals("y")) {
									...
									teby = false;
									finish();
									Toast.makeText(MyJuTuanOrderXqActivity.this, info,
											200).show();
								} else {
									progress.CloseProgress();
									teby = false;
						...
						public void onFailure(Throwable arg0, String arg1) {
							...
							System.out.println("22================================="
									+ arg1);
							Toast.makeText(MyJuTuanOrderXqActivity.this, "网络超时异常", 200)
									.show();
						}

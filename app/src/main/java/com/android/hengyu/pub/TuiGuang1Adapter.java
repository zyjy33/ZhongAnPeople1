...
public class TuiGuang1Adapter extends BaseAdapter {
	...
	public TuiGuang1Adapter(Context context, ArrayList<TuiGuangBean> lists,
	...
	public View getView(final int groupPosition, View convertView,
		...
		try {
			...
			System.out.println("-----------------------------"
					+ lists.get(groupPosition).getAdd_time());

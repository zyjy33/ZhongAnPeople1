...
public class JianKangGridViewAdaper extends BaseAdapter {
	...
	public JianKangGridViewAdaper(ArrayList<SpListData> list,Context context){
		this.list = list;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		try {
			...
			if (convertView == null) {
				...
				convertView = mInflater.inflate(R.layout.ylsc_list_item, null);
				//			holder.ll_kedikou = (LinearLayout) convertView.findViewById(R.id.ll_kedikou);
				holder.img = (ImageView) convertView.findViewById(R.id.img_ware);
				holder.tv_biaoti = (TextView) convertView.findViewById(R.id.tv_zhuti);
				holder.tv_hengyu_money = (TextView) convertView.findViewById(R.id.tv_sell_price);
				holder.tv_shichangjia = (TextView) convertView.findViewById(R.id.tv_market_price);

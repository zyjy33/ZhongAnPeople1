...
public class TuanchengyuanAdapterll extends BaseAdapter {
	...
	// public TuanchengyuanAdapter(ArrayList<JuTuanGouData> list, ArrayList
	// datadz,Context context) {// List<Integer> list_num, ArrayList datadz,
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		// circleImageView =
		// (XCRoundImageViewByXfermode)convertView.findViewById(R.id.cicleImageView);
	...
	Runnable getPicByUrl = new Runnable() {
		...
		public void run() {
			try {
				...
				String img_url2 = RealmName.REALM_NAME_HTTP

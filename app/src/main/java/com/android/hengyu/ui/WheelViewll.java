 ...
 */
public class WheelViewll extends View {
	/** Scrolling duration */
	 ...
	 * Constructor
	 */
	public WheelViewll(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * Constructor
	 */
	public WheelViewll(Context context, AttributeSet attrs) {
		super(context, attrs);
		initData(context);
	}
	 ...
	 * Constructor
	 */
	public WheelViewll(Context context) {
		super(context);
		initData(context);
	}

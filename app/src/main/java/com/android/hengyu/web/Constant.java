...
public class Constant {
    ...
    // public static final String MCH_ID = "1271349101";
    ...
    public static final String LONGUSERSET = "longuserset";
    public static final int DELETE = 1; //删除
    public static final int TO_PAY = 2; //去付款
    public static final int COMPLETE_ORDER = 3; //完成
    public static final int EVALUATE = 4; //评价
    public static final int REQUEST_COMPLETE_ORDER = 4;//完成订单的 activityRequest

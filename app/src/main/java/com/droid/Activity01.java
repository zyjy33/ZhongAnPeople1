...
public class Activity01 extends Activity implements OnScrollListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // "/data/data/com.zams.www/databases/";//修改为当前项目的包名
        try {
            ...
            personList.setOnItemClickListener(new OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view,
                    ...
                    if (position >= 4) {
                        ...
                        // "3"+allCity_lists.get(position).getName(),
                        // Toast.LENGTH_SHORT).show();
                        SharedPreferences spPreferences = getSharedPreferences(
                                "longuserset_city", MODE_PRIVATE);
                        spPreferences.edit().clear().commit();
                        Editor editor = spPreferences.edit();
                        editor.putString("city", allCity_lists.get(position)
                                .getName());
                        editor.commit();
                        finish();
                    }
            ...
            resultList.setOnItemClickListener(new OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view,
                                        int position, long id) {
                    // Toast.makeText(getApplicationContext(),
                    // "4"+city_result.get(position).getName(),
                    // Toast.LENGTH_SHORT)
                    // .show();
                    System.out.println("--------------"
                    ...
                    spPreferences.edit().clear().commit();
                    Editor editor = spPreferences.edit();
                    editor.putString("city", city_result.get(position)
                            .getName());
                    editor.commit();
                    finish();
                }
            ...
            if (viewType == 0) { // 定位
                ...
                city.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        AndPermission.with(Activity01.this)
                                ...
                                .onDenied(new Action() {
                                    @Override
                                    public void onAction(List<String> permissions) {
                                        new PermissionSetting(Activity01.this).showSetting(permissions);
                                    }
                                }).start();
                    }
                ...
                try {
                    ...
                    rencentCity.setAdapter(new HitCityAdapter(context,
                            this.hisCity));
                    rencentCity
                ...
                hotCity.setOnItemClickListener(new OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view,
                        ...
                        // Toast.makeText(getApplicationContext(),
                        // "2"+city_hot.get(position).getName(),
                        // Toast.LENGTH_SHORT).show();
                        System.out.println("--------------"
                        ...
                        spPreferences.edit().clear().commit();
                        Editor editor = spPreferences.edit();
                        editor.putString("city", city_hot.get(position)
                                .getName());
                        editor.commit();
                        finish();
                    }

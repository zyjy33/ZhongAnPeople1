...
public class MyShoppingCartActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		spPreferences = MyShoppingCartActivity.this.getSharedPreferences(
	...
	public void onResume() {
		...
		try {
			...
			// StringBuffer zhou = ShoppingCartActivity.str;
				...
				case 0:
					try {
						...
						adapter = new MyShopingCartllAdapter(list_ll,
								MyShoppingCartActivity.this, handler);
				...
				case 2:
					try {
						...
						if (shopping_id > 0) {
							...
							Toast.makeText(MyShoppingCartActivity.this,
									"请勾选要下单的商品", 200).show();
						}
					} catch (Exception e) {
						// TODO: handle exception
				...
				public void onSuccess(int arg0, String arg1) {
					...
					try {
						...
						if (status.equals("y")) {
							...
							progress.CloseProgress();
							Toast.makeText(MyShoppingCartActivity.this, info,
									200).show();
						}
					} catch (JSONException e) {
						// TODO Auto-generated catch block

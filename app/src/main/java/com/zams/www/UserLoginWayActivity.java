...
public class UserLoginWayActivity extends BaseActivity implements
		OnClickListener {
		...
		public void dispatchMessage(android.os.Message msg) {
			...
			switch (msg.what) {
				...
				case 1:
					...
					Toast.makeText(UserLoginWayActivity.this, str, 200).show();
					break;
				case 7:
	...
	private class BaseUiListener implements IUiListener {
		...
		public void onError(UiError e) {
			Util.toastMessage(UserLoginWayActivity.this, "onError: "
					+ e.errorDetail);
			Util.dismissDialog();
		}

...
public class GuideActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String userName = spPreferences.getString("user", "");
        String userPwd = spPreferences.getString("pwd", "");
        if (!TextUtils.isEmpty(userName) && !TextUtils.isEmpty(userPwd)) {
            String strUrlone = RealmName.REALM_NAME_LL + "/user_login?site=mobile&username=" +
                    userName + "&password=" + userPwd + "&terminal=true";

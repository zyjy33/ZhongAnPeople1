...
public class MedicalItems {
	...
	public String toString() {
		return "MedicalItems [id=" + id + ", medical_type=" + medical_type
				+ ", medical_name=" + medical_name + ", medical_price="
				+ medical_price + ", points=" + points + ", normal_value="
				+ normal_value + ", medical_barcode=" + medical_barcode
				+ ", service_ids=" + service_ids + ", img_url=" + img_url + "]";
	}

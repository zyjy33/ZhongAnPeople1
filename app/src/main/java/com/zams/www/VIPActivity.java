...
public class VIPActivity extends BaseActivity{
		...
		public void dispatchMessage(android.os.Message msg) {
			switch (msg.what) {
				case 1:
					...
					Vip_dAdapter adapter = new Vip_dAdapter(getApplicationContext(), lists, imageLoader, screenWidth);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		test.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, (int) (scale_1*screenWidth)));
			...
			public void onSuccess(int arg0, String arg1) {
				...
				try {
					...
					for(int i=0;i<len;i++){
						...
						d.setProductBenchmarkPriceID(object.getString("ProductBenchmarkPriceID"));

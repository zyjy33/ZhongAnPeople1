...
//
//public class ShoppingCartllActivity extends Fragment {
...
//
//	public ShoppingCartllActivity(ImageLoader loader) {
...
//													"聚红包不足", 200).show();
//										} else {
//											System.out.println("值是多少1111111111111=========================="+carts);
...
//							 * 4为零价商城（即云商聚系统中的福利兑换）里面的商品。 5为抽奖活动里设置的商品，
//							 * 6表示一元聚购的业务商品，
...
//			data.uploadStatus = object.getBoolean("uploadStatus");
//			data.IsDeleted = object.getBoolean("IsDeleted");
//			if (abe.length() == 0) {
//				data.jf = 0;
//			} else {
...
//		btn_sittle_account = (Button) layout
...
//		tv_endmarketprice = (TextView) layout
...
//		adapter = new MyShopCartAdapter(carts, getActivity(), handler,
//				imageLoader);
